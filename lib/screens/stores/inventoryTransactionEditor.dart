                ...
                title: DropdownButton<String>(
                        ...
                        items: <String>['transfer', 'sales', 'purchases', 'losses']
                          ...
                          return DropdownMenuItem<String>(
                            value: value,
                            child: Text(value == "sales" ? "مبيعات" : value == "purchases" ? "مشتريات"  : value == "transfer" ? "نقل"  : "هوالك"),
                          );
                        }).toList(),
                      ),
                ),
