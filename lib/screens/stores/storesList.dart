            ...
            Row(
              children: [
                Expanded(
                  ...
                  icon: FontAwesomeIcons.plus,
                  handler: () => Navigator.pushNamed(context, '/inventory_transactions_editor'),
                )),
                Expanded(
                    child: CustomeButton(
                  title: "حركة المخزون",
                  icon: FontAwesomeIcons.truckLoading,
                  handler: () => Navigator.pushNamed(context, '/inventory_transactions'),
                )),
              ],
            ),
