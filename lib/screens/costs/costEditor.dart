  ...
  Widget build(BuildContext context) {
    save() async {
      ...
      if (_formKey.currentState.validate()) {
        await CostServices.createCost(amount: amount.text, notes: notes.text, type: type, context: context);
      }
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        title: DropdownButton<String>(
                          ...
                          items:
                              <String>['expenses', 'losses', 'salaries'].map<DropdownMenuItem<String>>((String value) {
                            return DropdownMenuItem<String>(
                              value: value,
                              child: Text(value == "expenses"
                                  ? "مصاريف"
                                  : value == "losses"
                                      ? "هوالك"
                                      : "مرتبات"),
