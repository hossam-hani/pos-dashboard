          ...
          body: Padding(
            ...
            child: SafeArea(
                  ...
                  child: Padding(
                    ...
                    SizedBox(width: 10,),
                    Text("الفواتير".tr(),style: TextStyle(fontSize: 20),)
                      ],),
...
class CustomeTextField extends StatelessWidget {
  ...
  CustomeTextField({this.hintTxt,this.labelTxt,this.controller,
  this.validator,this.obscureTextbool = false});
...
class ListItem extends StatelessWidget {
  ...
  ListItem({this.customerName,this.id,this.total,this.date,this.items,
  this.tax1,
  this.tax1Amount,
  this.tax2,
  this.tax2Amount,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      tax1 == null || tax1 == "null"  ? SizedBox() :   Text(
      ...
      tax2 == null || tax2 == "null" ?SizedBox() :   Text(
      ...
      tax3 == null || tax3 == "null" ? SizedBox() :   Text(
