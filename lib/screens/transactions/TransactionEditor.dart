...
class TranscationEditor extends StatefulWidget {
  ...
  TranscationEditor({this.transaction});
...
class _TranscationEditorState extends State<TranscationEditor> {
  ...
  save() async {
    ...
    await TransactionsServices.saveTransaction(
      ...
      id: widget.transaction == null ? null : widget.transaction.id.toString());
      }
        ...
        body: SingleChildScrollView(
              ...
              child: Column(
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child:   Text(
                    widget.transaction != null ? "edit_transaction".tr() : "add_transaction".tr(),
                    style: TextStyle(  
                      fontSize: 20,
