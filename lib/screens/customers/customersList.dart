...
class CustomerList extends StatefulWidget {
  ...
  CustomerList({this.changePageHandler,this.keyword,this.customerID});
...
class _CustomerListState extends State<CustomerList> {
  ...
  Future<List<Customer>> getProductsLocal() async {
    ...
    List<Customer> temp = await CustomerServices.getCustomers(currentPage.toString(),widget.keyword);
        ...
        backgroundColor: Colors.white,
          body: SafeArea(
                ...
                child: Padding(
                  ...
                  widget.keyword != null || widget.customerID != null ? SizedBox() : Padding(
...
class ListItem extends StatelessWidget {
  ...
  ListItem({this.addresses,this.id,this.name,this.phoneNumber});
  @override
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
    ...
    Container(
      ...
      child: Row(
        children: [
                ...
                Expanded(child: CustomeButton(title: "customer_orders".tr(),
                mainColor: true,
