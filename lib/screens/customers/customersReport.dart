        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                title: Text("اجمالي ارصدة العملاء : ${totalBalance ?? "0"} EGP "),
              ),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                          child: CustomeButton(
                        title: "اذونات السداد الخاص بالعميل".tr(),
                        icon: null,
                        handler: () {
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                          child: CustomeButton(
                              title: "اذونات السداد من تاريخ الي تاريخ".tr(),
                              icon: null,
                              handler: () {
                                Navigator.pushNamed(context, '/transactions_reports', arguments: {
                                  "customerId": id,
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                          child: CustomeButton(
                        title: "فواتير العميل".tr(),
                        mainColor: true,
                        icon: null,
                        handler: () =>
                            Navigator.pushNamed(context, '/orders', arguments: {"keyword": null, "customerId": id}),
                      )),
                    ],
                  ),
                ),
                Container(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                          child: CustomeButton(
                        title: "فواتير العميل من فترة الي فترة".tr(),
                        mainColor: true,
                        icon: null,
                        handler: () =>
                            Navigator.pushNamed(context, '/orders', arguments: {"keyword": null, "customerId": id}),
