...
class _ProductEditorState extends State<ProductEditor> {
  ...
  save() async {
    ...
    if (_formKey.currentState.validate()) {
      ...
      await ProductServices.saveProduct(name: name.text, description : description.text,
        isActive: _isActive, images: imgsbase64.length > 0 ? imgsbase64 : null,
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        body: SingleChildScrollView(
              ...
              child: isLoading ? SizedBox() : Column(
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child:   Text(
                    widget.product != null ? "edit_product".tr() : "add_product".tr(),
                    style: TextStyle(  
                      fontSize: 20,
              ...
              categories == null ? SizedBox() : DropdownButton<Category>(
                    ...
                    onTap: addnewImageToList,
                      ...
                      child: Container(
                          child: Column(
                              ...
                              FaIcon(FontAwesomeIcons.images,color: Color(0xFFFF6A37),size: 40,),
                              SizedBox(height: 10,),
                              Text(
                                'select_image'.tr(),
                                style: TextStyle(
              ...
              Divider(),
              imagesUrl == null ? SizedBox() : imagesUrl.length != 0 ? Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("الصور السابقة"),
                  Container(
