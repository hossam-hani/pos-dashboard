            ...
            Row(
              children: [
                CustomeButton(
                  ...
                  handler: () => Navigator.pushNamed(context, '/stocks_editor',
                      arguments: StockEditorArgumants(onSaveFinish: _reloadData)),
                ),
              ],
            ),
            stocks.isEmpty && !isLoading ? CategoryPlaceholder() : SizedBox(),
            stocks.isEmpty && !isLoading
                ? SizedBox()
                : Expanded(
                    child: Padding(
                      ...
                      child: Pagination(
                        ...
                        itemBuilder: (index, Stock stock) => ListItem(
                          title: "${stock.product.name} | ${"quantity".tr()} : ${stock.quantity}",
