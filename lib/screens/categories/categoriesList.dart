        ...
        Row(
          children: [
            CustomeButton(
              ...
              handler: () => Navigator.pushNamed(context, '/category_editor',
                  arguments: CategoryEditorArgumants(
            ...
            CustomeButton(
              ...
              handler: () => widget.changeCurrentIndex(0),
            ),
          ],
        ),
            ...
            : Expanded(
                child: Padding(
                  ...
                  child: Pagination(
                    ...
                    itemBuilder: (index, Category category) {
                      return ListItem(
                        onSaveFinish: _reloadData,
...
class ListItem extends StatelessWidget {
  ...
  ListItem({this.title, this.id, this.image, this.category, @required this.onSaveFinish});
  @override
  Widget build(BuildContext context) {
    return InkWell(
