...
class RegionsServices{
  ...
  static Future<List<Region>> getAllMainRegions() async {
    ...
    static Future<Region> saveRegion({String name,String fees, bool isActive, String regionId, String id}) async {
      ...
      try {
        ...
        Response response = await dio.post(id != null ? "$baseUrl/regions/$id" : "$baseUrl/regions",data: 
        regionId != null ? {
          "name" : name,
          "is_active" : isActive,
          "fees" : fees,
