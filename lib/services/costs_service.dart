...
class CostServices {
  ...
  static Future<Cost> updateSatus({String costId, String newStatus}) async {
    ...
    try {
      ...
      Response response = await dio.post("$baseUrl/costs/$costId",data: {
        "status" : newStatus,
      },  options: Options(
  ...
  static Future<List<Order>> getOrders(String currentPage,String keyword,String customerID,bool neworder) async {
    ...
    static Future<List<Cost>> getCostsReport(String currentPage,{String startAt, String endAt,String type}) async {
    ...
    try {
      ...
      Response response = await dio.post("$baseUrl/costs",data: {
        "amount" : amount,
        "type" : type,
        "notes" : notes,
      },  options: Options(
