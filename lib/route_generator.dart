  ...
  static Route<dynamic> generateRoute(RouteSettings settings){
    ...
    switch (settings.name){
      ...
      case '/transactions_reports' :
        return MaterialPageRoute(builder: (_) => TransactionsReport(customerId: (args as Map)["customerId"],startAt: (args as Map)["startAt"],endAt: (args as Map)["endAt"],));
      ...
      case '/suppliers_invoices' :
        return MaterialPageRoute(builder: (_) => SuppliersInvoicesReport(supplierId: (args as Map)["supplierId"],startAt: (args as Map)["startAt"],endAt: (args as Map)["endAt"]));    
      // case '/inventory_transactions_editor' :
      //   return MaterialPageRoute(builder: (_) => InventoryTransactionEditor()); 
      case '/cost_editor' :
      ...
      case '/orders_reports' :
        return MaterialPageRoute(builder: (_) => OrdersReport(customerId: (args as Map)["customerId"],startAt: (args as Map)["startAt"],endAt: (args as Map)["endAt"]));
      case '/vstists_reports' :
        return MaterialPageRoute(builder: (_) => VstistsReport(customerId: (args as Map)["customerId"],startAt: (args as Map)["startAt"],endAt: (args as Map)["endAt"]));   
      case '/costs_reports' :
        return MaterialPageRoute(builder: (_) => CostsReport(type: (args as Map)["type"],startAt: (args as Map)["startAt"],endAt: (args as Map)["endAt"],));
